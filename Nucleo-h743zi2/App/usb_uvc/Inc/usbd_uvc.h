...
#define UVC_NAME "ZX Camera"

//#define UVC_MAX_FS_PACKET            64
#define UVC_MAX_HS_PACKET            0x400

// in bytes
#define UVC_IN_EP1_PACKET_SIZE         (1024)

#define UVC_VIDEO_MAX_FRAME_BUF_SIZE (UVC_VIDEO_WIDTH*UVC_VIDEO_HEIGHT*UVC_BYTE_PER_PIX)
#define UVC_VIDEO_FPS          (50)
...
//#define DBVAL2(x) (x & 0xFF),((x >> 8) & 0xFF),{((x >> 16) & 0xFF)},((x >> 24) & 0xFF)
