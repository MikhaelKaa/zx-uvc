...
#define USBD_MANUFACTURER_STRING     "Kaa"
#define USBD_PID_HS     22336
#define USBD_PRODUCT_STRING_HS     "uvc4zx-spectrum"
#define USBD_CONFIGURATION_STRING_HS     "uvc"
#define USBD_INTERFACE_STRING_HS     "uvc"
